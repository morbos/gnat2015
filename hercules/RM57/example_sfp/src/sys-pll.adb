...
package body Sys.Pll is
   ...
   procedure Initialize_Clocks is
      PLL_Mult    : constant Unsigned_32 := 150 - 1;
      Refclkdiv   : constant Unsigned_32 := 8 - 1;
   begin
      ...
      Rmw (SMF1.PLLCTL2, ODPLL, 1 - 1);
      Rmw (SMF1.PLLCTL2, MULMOD, 7);
      Rmw (SMF1.PLLCTL2, SPREADINGRATE, 255);

      Rmw (SMF2.PLLCTL3, PLL_MUL2, Shift_Left (PLL_Mult, 8));
      Rmw (SMF2.PLLCTL3, REFCLKDIV2, Refclkdiv);
      Rmw (SMF2.PLLCTL3, PLLDIV2, 16#1f#);
      Rmw (SMF2.PLLCTL3, ODPLL2, 1 - 1);

      Rmw (SMF1.CSDIS, 7, 0, 16#8C#);
   ...
   begin
      ...
      Rmw (SMF1.PLLCTL1, PLLDIV, 16#0#);
      Rmw (SMF2.PLLCTL3, PLLDIV2, 16#0#);
