...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#cb239bfc#;
   ...
   u00006 : constant Version_32 := 16#4e0af81e#;
   ...
   u00009 : constant Version_32 := 16#59f2ba18#;
   ...
   u00016 : constant Version_32 := 16#d930e645#;
   ...
   u00018 : constant Version_32 := 16#41d04c37#;
   pragma Export (C, u00018, "system__bb__parametersS");
   u00019 : constant Version_32 := 16#d537ae47#;
   pragma Export (C, u00019, "system__rm57S");
   ...
   u00023 : constant Version_32 := 16#552f1d8f#;
   pragma Export (C, u00023, "system__bb__cpu_primitivesB");
   u00024 : constant Version_32 := 16#dc9fb9cc#;
   ...
   u00030 : constant Version_32 := 16#90b44569#;
   ...
   u00032 : constant Version_32 := 16#80e7b3b8#;
   ...
   u00034 : constant Version_32 := 16#91fc7a99#;
   ...
   u00038 : constant Version_32 := 16#db6dbd7f#;
   ...
   u00045 : constant Version_32 := 16#5fc0cf69#;
   pragma Export (C, u00045, "system__bb__interruptsS");
   u00046 : constant Version_32 := 16#308b3d8b#;
   ...
   u00067 : constant Version_32 := 16#c1e742f9#;
   pragma Export (C, u00067, "gioportsB");
   u00068 : constant Version_32 := 16#a95b5f68#;
   pragma Export (C, u00068, "gioportsS");
   u00069 : constant Version_32 := 16#38c683e4#;
   pragma Export (C, u00069, "accessorB");
   u00070 : constant Version_32 := 16#5634fcc7#;
   ...
   u00074 : constant Version_32 := 16#9c512d98#;
   pragma Export (C, u00074, "initB");
   u00075 : constant Version_32 := 16#188324c4#;
   pragma Export (C, u00075, "initS");
   u00076 : constant Version_32 := 16#c05d8c1c#;
   pragma Export (C, u00076, "sysB");
   u00077 : constant Version_32 := 16#07cdead7#;
   pragma Export (C, u00077, "sysS");
   u00078 : constant Version_32 := 16#4fba5718#;
   pragma Export (C, u00078, "sys__muxB");
   u00079 : constant Version_32 := 16#a58a1055#;
   pragma Export (C, u00079, "sys__muxS");
   u00080 : constant Version_32 := 16#fc5e76fa#;
   pragma Export (C, u00080, "sys__periphB");
   u00081 : constant Version_32 := 16#a195e8cd#;
   pragma Export (C, u00081, "sys__periphS");
   u00082 : constant Version_32 := 16#69287125#;
   pragma Export (C, u00082, "sys__flashB");
   u00083 : constant Version_32 := 16#cfb7fb0f#;
   pragma Export (C, u00083, "sys__flashS");
   u00084 : constant Version_32 := 16#2c265f8f#;
   pragma Export (C, u00084, "sys__pllB");
   u00085 : constant Version_32 := 16#ec5b707b#;
   pragma Export (C, u00085, "sys__pllS");
   u00086 : constant Version_32 := 16#e3b58255#;
   pragma Export (C, u00086, "sys__vimB");
   u00087 : constant Version_32 := 16#5bf32048#;
   pragma Export (C, u00087, "sys__vimS");
   u00088 : constant Version_32 := 16#b8e4440a#;
   pragma Export (C, u00088, "last_chance_handlerB");
   u00089 : constant Version_32 := 16#703c9fb9#;
   pragma Export (C, u00089, "last_chance_handlerS");
   u00090 : constant Version_32 := 16#570325c8#;
   pragma Export (C, u00090, "system__img_intB");
   u00091 : constant Version_32 := 16#a8b68f7f#;
   pragma Export (C, u00091, "system__img_intS");
