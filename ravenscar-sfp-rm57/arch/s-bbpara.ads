...
--  This is the RM57 (Cortex-R5F) (ARMv7-R) version of this package
...
package System.BB.Parameters is
   ...
   --  SoC can run up to 330Mhz but we cap at 300 so that HCLK is 150Mhz (max)
   ...
   --  Number of interrupts supported by the VIC. For the RM57 interrupts,
   ...
   --  The RM57 processor needs to save:
