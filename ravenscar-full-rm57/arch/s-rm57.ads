...
package System.RM57 is
   ...
   Peripherals_Frame3 : constant := 16#fff7_8000#;
   ...
   PCR2_Base    : constant := Peripherals_Frame2 + 16#00FF_1000#;
   PCR3_Base    : constant := Peripherals_Frame3 + 16#0000_0000#;
   ...
   I2C1_Base    : constant := Peripherals_Frame1 + 16#00F7_D400#;
   I2C2_Base    : constant := Peripherals_Frame1 + 16#00F7_D500#;
   ...
   DCAN4_Base   : constant := Peripherals_Frame1 + 16#00F7_E200#;
   LIN1_Base    : constant := Peripherals_Frame1 + 16#00F7_E400#;
   SCI3_Base    : constant := Peripherals_Frame1 + 16#00F7_E500#;
   LIN2_Base    : constant := Peripherals_Frame1 + 16#00F7_E600#;
   SCI4_Base    : constant := Peripherals_Frame1 + 16#00F7_E700#;
   ...
   RTP_RAM_Base         : constant := System_Modules + 16#0_3000#;
   ...
   PCR1_Base            : constant := System_Modules + 16#7_1000#;
   IOMM_Base            : constant := System_Modules + 16#7_1c00#;
   ...
   DCC1_Base            : constant := System_Modules + 16#7_ec00#;
   ...
   CCMR5_Base           : constant := System_Modules + 16#7_f600#;
   ...
   PCR1 : PCR_Registers with Volatile, Address
     => System'To_Address (PCR1_Base);
   PCR2 : PCR_Registers with Volatile, Address
     => System'To_Address (PCR2_Base);
   PCR3 : PCR_Registers with Volatile, Address
     => System'To_Address (PCR3_Base);
   ...
   type VIM_Parity_Register is record
      ...
      ECCSTAT   : Word; -- Interrupt Vector Table ECC stat Register 16#EC#
      ECCCTL    : Word; -- Interrupt Vector Table ECC Control Reg 16#F0#
      UERRADDR  : Word; -- Uncorrectable Error Address Register 16#F4#
      FBVECADDR : Word; -- Fallback Vector Address Register 16#F8#
      SBERRADDR : Word; -- Single Bit Error Address Register 16#FC#
   end record;
